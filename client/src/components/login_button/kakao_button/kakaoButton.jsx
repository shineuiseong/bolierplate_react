...
const KakaoButton = ({ onClick }) => (
  <div className={styles.buttonWrapper}>
    <button className={styles.button} onClick={onClick}>
      <svg id="Bold" enableBackground="new 0 0 24 24" width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <p className={styles.loginDescription}>카카오 로그인</p>
  </div>
)
